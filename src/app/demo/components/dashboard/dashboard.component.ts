...
export class DashboardComponent implements OnInit, OnDestroy {
    ...
    constructor(private FarmsService: FarmsService, public layoutService: LayoutService, private MessageService: MessageService) {
        ...
        this.chartData = {
            ...
            datasets: [
                ...
                },
                {
                    ...
                    fill: false,
                    backgroundColor:
                        documentStyle.getPropertyValue('--cayan-400'),
